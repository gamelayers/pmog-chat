...
var Sortable = {
  ...
  create: function(element) {
    ...
    options.draggables = $PA();
    options.droppables = $PA();
    ...
    (this.findElements(element, options) || $PA()).each( function(e) {
  ...
  findElements: function(element, options) {
    ...
    var elements = $PA();
    $PA(element.childNodes).each( function(e) {
  ...
  serialize: function(element) {
    ...
    return $(this.findElements(element, options) || $PA()).collect( function(item) {
      return (encodeURIComponent(options.name) + "$PA()=" + 
