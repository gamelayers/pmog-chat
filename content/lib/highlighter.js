...
var Highlighter = {
	...
	*/
    ...
    /**
        Wraps the given selection with the nodeName and attributes.
        
        Ex. Highlighter.set(window, selection, 'span', {style='blahblah'});
    */
	set : function(aWindow, aSelection, aNodeName, aAttributes)
	{
		...
		for ( var r = 0; r < aSelection.rangeCount; ++r ) {
			...
			{
				log("error: Can't attach link across tags."); return;
			}
