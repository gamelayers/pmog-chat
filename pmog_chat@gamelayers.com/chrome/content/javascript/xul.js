...
addTab: function(title) {
        ...
        if (title.indexOf("#") != -1) {
            ...
            var ignore = SPECIAL_USERS.indexOf(cTitle) != -1;
            if (ignore) {
...
getOrCreateChannelTab: function(channel) {
        var chatTab = this.getChannelTab(channel);
        if (chatTab === undefined) {
            chatTab = this.addTab(channel);
